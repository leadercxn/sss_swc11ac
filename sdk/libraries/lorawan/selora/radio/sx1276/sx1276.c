...
static bool     m_io_initialized = false;                                     
...
//            
//            err_code = app_timer_start(RxTimeoutSyncWord, 
//						   APP_TIMER_TICKS(( 8.0 * ( SX1276.Settings.Fsk.PreambleLen +
//                                                         ( ( SX1276Read( REG_SYNCCONFIG ) &
//                                                            ~RF_SYNCCONFIG_SYNCSIZE_MASK ) +
//                                                         1.0 ) + 10.0 ) /
//                                                        ( double )SX1276.Settings.Fsk.Datarate ) * 1e3, 0), NULL);
...
//                    err_code = app_timer_start(RxTimeoutSyncWord, 
//						   APP_TIMER_TICKS(LED_BLINK_TIME, 0), NULL);
//                    APP_ERROR_CHECK(err_code);
            ...
            case MODEM_LORA:
                {
                    ...
                    if( ( RadioEvents != NULL ) && ( RadioEvents->RxDone != NULL ) )
                    {
                        SX1276.Settings.LoRaPacketHandler.SnrValue = snr; //wanghuayuan
...
//                    err_code = app_timer_stop(RxTimeoutSyncWord);
//                    APP_ERROR_CHECK(err_code);
