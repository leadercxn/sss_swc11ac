...
typedef struct sLoRaMacParams
{
    ...
    uint8_t MaxEirp;
    /*!
     * The last time stamp whick is requested from server
     */
...
typedef struct sMcpsIndication
{
    ...
    uint32_t DownLinkCounter;
    /*!
     * The downlink frequency related to the frame
     */
    uint32_t DownLinkFrequency;
    /*!
     * Set if a MAC command was received
     */
    bool MCNeedAck;
} McpsIndication_t;
...
typedef enum eMib
{
    ...
    MIB_RX2_CHANNEL,
    /*!
    * Set receive window 2 channel default
    *
    * LoRaWAN Specification V1.0.1, chapter 3.3.2
    */
    MIB_RX2_CHANNEL_DEFAULT,
    /*!
    ...
    MIB_CHANNELS_NB_REP,
    /*!
    * Set the default number of repetitions on a channel
    *
    * LoRaWAN Specification V1.0.1, chapter 5.2
    */
    MIB_CHANNELS_DEFAULT_NB_REP,
    /*!
    ...
    MIB_RECEIVE_DELAY_1,
    /*!
    * Receive default delay 1 in [ms]
    *
    * LoRaWAN Specification V1.0.1, chapter 7
    */
    MIB_DEFAULT_RECEIVE_DELAY_1,
    /*!
    ...
    MIB_RECEIVE_DELAY_2,
    /*!
    * Receive default delay 2 in [ms]
    *
    * LoRaWAN Specification V1.0.1, chapter 7
    */
    MIB_DEFAULT_RECEIVE_DELAY_2,
    /*!
    ...
    /*!
    * Join accept default delay 1 in [ms]
    *
    * LoRaWAN Specification V1.0.1, chapter 7
    */
    MIB_JOIN_DEFAULT_ACCEPT_DELAY_1,
    /*!
    ...
    /*!
    * Join accept default delay 2 in [ms]
    *
    * LoRaWAN Specification V1.0.1, chapter 7
    */
    MIB_JOIN_DEFAULT_ACCEPT_DELAY_2,
    /*!
    ...
    /*!
     * Data rate offset of a channel
     *
     * LoRaWAN Specification V1.0.1, chapter 7
     */
    MIB_CHANNELS_DATARATE_OFFSET,
    /*!
     * Data rate default offset of a channel
     *
     * LoRaWAN Specification V1.0.1, chapter 7
     */
    MIB_CHANNELS_DEFAULT_DATARATE_OFFSET,
    /*!
...
typedef union uMibParam
{
    ...
    */
    Rx2ChannelParams_t Rx2Channel;
    /*!
    * default channel for the receive window 2
    *
    * Related MIB type: \ref MIB_RX2_CHANNEL_DEFAULT
    */
    Rx2ChannelParams_t Rx2ChannelDefault;
    /*!
     * Channel mask
     *
    ...
    /*!
    * Default number of frame repetitions
    *
    * Related MIB type: \ref MIB_CHANNELS_DEFAULT_NB_REP
    */
    uint8_t ChannelDefaultNbRep;
    /*!
    ...
    uint32_t ReceiveDelay1;
    /*!
    * Default receive delay 1
    *
    * Related MIB type: \ref MIB_DEFAULT_RECEIVE_DELAY_1
    */
    ...
    uint32_t ReceiveDelay2;
    /*!
    * Default receive delay 2
    *
    * Related MIB type: \ref MIB_DEFAULT_RECEIVE_DELAY_2
    */
    ...
    uint32_t JoinAcceptDelay1;
    /*!
    * Default join accept delay 1
    *
    * Related MIB type: \ref MIB_JOIN_DEFAULT_ACCEPT_DELAY_1
    */
    uint32_t JoinDefaultAcceptDelay1;
    /*!
     * Join accept delay 2
     *
    ...
    uint32_t JoinAcceptDelay2;
    /*!
    * Default join accept delay 2
    *
    * Related MIB type: \ref MIB_JOIN_DEFAULT_ACCEPT_DELAY_2
    */
    uint32_t JoinDefaultAcceptDelay2;
    /*!
     * Channels data rate
     *
    ...
    int8_t ChannelsDatarate;
    /*!
     * Channels data rate offset
     *
     * Related MIB type: \ref MIB_CHANNELS_DATARATE
     */
    uint8_t ChannelsDatarateOffset;
    /*!
    * Default channels data rate offset
    *
    * Related MIB type: \ref MIB_CHANNELS_DEFAULT_DATARATE
    */
    uint8_t ChannelsDefaultDatarateOffset;
    /*!
     * Channels TX power
     *
    ...
    * DefaultMaxEIRP
    */
    uint8_t DefaultMaxEirp;
    /*!
    * LastTimeStamp
    */
    uint64_t LastTimeStamp;
    /*!
     * LbtEnable, wanghuayuan
     */
    bool LbtEnable;
    /*!
     * LbtThreshold, wanghuayuan
     */
    int32_t LbtThreshold;
    /*!
     * LbtRetryTimes, zhangtieming
     */
    uint8_t LbtRetryTimes;
} MibParam_t;
...
typedef enum eLoRaMacRegion_t
{
     ...
     *
     */
    LORAMAC_REGION_AU915_HYBRID,
    /*!
     *
     */
    LORAMAC_REGION_SE800,
    /*!
     *
     */
    LORAMAC_REGION_INVALID,
} LoRaMacRegion_t;
...
typedef struct sLoRaMacCallback
{
    ...
    /*!
    * \brief   Mac command callback
    */
    void ( *MacCommandCallback)(void * type);
