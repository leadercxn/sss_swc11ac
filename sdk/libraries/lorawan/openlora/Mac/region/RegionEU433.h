 ...
 * Default Max EIRP
 */
#define EU433_DEFAULT_MAX_EIRP                      12
 ...
 */
#ifdef DEBUG
#define EU433_BAND0                                 { 1, EU433_DEFAULT_TX_POWER, 0,  0 } //  1.0 %
#else
 ...
 */
#define EU433_RSSI_FREE_TH                          -90

/*!
 * Specifies the time the node performs a carrier sense
 */
#define EU433_CARRIER_SENSE_TIME                    6

/*!
 * Lbt check retry times
 */
#define EU433_LBT_RETRY_TIMES                   3
