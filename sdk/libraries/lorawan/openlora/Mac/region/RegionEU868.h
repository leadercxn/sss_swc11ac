 ...
 */
#ifdef DEBUG
#define EU868_BAND0                                 { 1 , TX_POWER_1, 0,  0 } //  1.0 %
#define EU868_BAND1                                 { 1 , TX_POWER_1, 0,  0 } //  1.0 %
#define EU868_BAND2                                 { 1 , TX_POWER_1, 0,  0 } //  1.0 %
#define EU868_BAND3                                 { 1 , TX_POWER_1, 0,  0 } //  1.0 %
#define EU868_BAND4                                 { 1 , TX_POWER_1, 0,  0 } //  1.0 %
#else
 ...
 */
#define EU868_RSSI_FREE_TH                          -90

/*!
 * Specifies the time the node performs a carrier sense
 */
#define EU868_CARRIER_SENSE_TIME                    6

/*!
 * Lbt check retry times
 */
#define EU868_LBT_RETRY_TIMES                   3
