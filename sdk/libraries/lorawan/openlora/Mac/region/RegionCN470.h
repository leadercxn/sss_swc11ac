 ...
 */
#define CN470_DEFAULT_DATARATE                      DR_3
 ...
 * Default Max EIRP
 */
#define CN470_DEFAULT_MAX_EIRP                      20
 ...
 */
#define CN470_RSSI_FREE_TH                          -65

/*!
 * Specifies the time the node performs a carrier sense
 */
#define CN470_CARRIER_SENSE_TIME                    6

/*!
 * Lbt check retry times
 */
#define CN470_LBT_RETRY_TIMES                   3
...
/*!
 * Preamble length of cad rx configuration. preamble len = bw/2^sf + 5.
 */
static const uint16_t PreambleLenOfCad[] = { 36, 66, 127, 249, 493, 982 };
...
/*!
 * \brief Configuration of the CAD RX windows.
 *
 * \retval Returns true, if the configuration was applied successfully.
 */
