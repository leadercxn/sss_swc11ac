...
typedef enum ePhyAttribute
{
    ...
    /*!
     * Default value for the LBT threshold. wanghuayuan
     */
    PHY_DEF_LBT_THRESHOLD,
    /*!
     * Default value for the LBT retry times. zhangtieming
     */
    PHY_DEF_LBT_RETRYTIMES
} PhyAttribute_t;
...
typedef struct sRxConfigParams
{
    ...
    bool Window;
    /*!
     * Judge data packet. the RX type. 0: other data packet, 1: cad data packet.
     */
    bool Type;
} RxConfigParams_t;
