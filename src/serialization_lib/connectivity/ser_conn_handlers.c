...
static ser_hal_transport_evt_rx_pkt_received_params_t m_rx_pkt_received_params;     //接收到的数据包数据结构 
...
{
    LOG_I("application_event : %s\n" , ser_hal_event_log_str(event.evt_type) );
    switch (event.evt_type)
    {
        case SER_HAL_TRANSP_EVT_TX_PKT_SENT:            //数据发送
        {
            //LOG_I( "SER_HAL_TRANSP_EVT_TX_PKT_SENT ====> \n" );
        ...
        case SER_HAL_TRANSP_EVT_RX_PKT_RECEIVING:   //数据包正在发送
        {
            //LOG_I( "SER_HAL_TRANSP_EVT_RX_PKT_RECEIVING ====> \n" );
        ...
        case SER_HAL_TRANSP_EVT_RX_PKT_RECEIVED:    //数据包接收完成
        {    
            //LOG_I( "SER_HAL_TRANSP_EVT_RX_PKT_RECEIVED ====> \n" );
        ...
        case SER_HAL_TRANSP_EVT_RX_PKT_DROPPED:     //数据包过长，丢包
        {
            //LOG_E( "SER_HAL_TRANSP_EVT_RX_PKT_DROPPED ====> \n" );
            APP_ERROR_CHECK(SER_WARNING_CODE);
            break;
        }

        case SER_HAL_TRANSP_EVT_PHY_ERROR:          //物理层错误
        {
            //LOG_E( "SER_HAL_TRANSP_EVT_PHY_ERROR ====> \n" );
